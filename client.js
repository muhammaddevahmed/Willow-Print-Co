...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (addAnotherBtn && guestAddresses) {
    ...
    guestAddresses.addEventListener("click", function (e) {
      if (
        e.target.classList.contains("remove-address") ||
...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbxKKBJd8_yjp5WSDOvx2LH5tyoUWxqao0q387MxqEqRz-LXdyAdg9h6F1ANe6awI00jKA/exec";
